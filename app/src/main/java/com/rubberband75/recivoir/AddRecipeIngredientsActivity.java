...
public class AddRecipeIngredientsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInput = (EditText)findViewById(R.id.addIngredient);
        add = (Button)findViewById(R.id.addButton);
        list = (ListView)findViewById(R.id.ingredientList);

        arrayList = new ArrayList<>();
        adapter = new ArrayAdapter<String>(AddRecipeIngredientsActivity.this, android.R.layout.simple_list_item_1,arrayList);
